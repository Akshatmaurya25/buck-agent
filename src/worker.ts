...
export const cryptoWorker = new GameWorker({
    ...
    functions: [getCryptoPriceFunction,getSeiWalletBalance, transferSEI ,buyCryptoFunction, sellCryptoFunction, transferCryptoFunction, getWalletBalanceFunction, getGeneralBalanceFunction],
    // Optional: Provide environment to LLP
    // getEnvironment: async () => {
