...
import { buyCryptoFunction, getCryptoPriceFunction, getWalletBalanceFunction, sellCryptoFunction, transferCryptoFunction ,getGeneralBalanceFunction } from "./cryptoFunctions";
...
export const cryptoWorker = new GameWorker({
    ...
    functions: [getCryptoPriceFunction, buyCryptoFunction, sellCryptoFunction, transferCryptoFunction, getWalletBalanceFunction, getGeneralBalanceFunction],
    // Optional: Provide environment to LLP
    // getEnvironment: async () => {
