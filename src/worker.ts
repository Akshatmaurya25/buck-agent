...
import { buyCryptoFunction, getCryptoPriceFunction, getWalletBalanceFunction, sellCryptoFunction, transferCryptoFunction } from "./cryptoFunctions";
...
export const cryptoWorker = new GameWorker({
    ...
    functions: [getCryptoPriceFunction, buyCryptoFunction, sellCryptoFunction, transferCryptoFunction, getWalletBalanceFunction],
    // Optional: Provide environment to LLP
    // getEnvironment: async () => {
