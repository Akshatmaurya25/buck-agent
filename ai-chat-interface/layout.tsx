...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-screen bg-[#141414] text-[#F1E9E9]">
      {/* Sidebar */}
      <div className="w-64 border-r bg-[#2E2E2E]">
        <div className="p-4 border-b border-[#3C2322]">
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded-full bg-[#3C2322]" />
      ...
      <div className="flex-1 flex">
        <div className="flex-1 flex flex-col">
          ...
          <header className="h-14 border-b border-[#3C2322] px-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="sm" className="text-[#F1E9E9] hover:bg-[#3C2322]">
                Save conversation
              </Button>
              <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-[#F1E9E9] hover:bg-[#3C2322]">
                <X className="h-4 w-4" />
              </Button>
            </div>
          </header>
