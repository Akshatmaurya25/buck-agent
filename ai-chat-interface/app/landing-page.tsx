...
export default function Component() {
  ...
  return (
    <div className={`relative w-full h-screen bg-[#E6DADA] text-[#D9736A] overflow-hidden ${manrope.className}`}>
      ...
      <Canvas shadows camera={{ position: [30, 30, 30], fov: 50 }} className="absolute top-1/4 inset-0">
        <Scene />
      </Canvas>
    </div>
  )
